...
export type FieldType = "text" | "number" | "tel" | "textarea" | "select" | "date";
...
export const sections: SectionConfig[] = [
  {
    ...
    fields: [
      { label: "Дата заказа", name: "orderDate", placeholder: "дд.мм.гггг", type: 'date' },
      { label: "Дата отгрузки", name: "shippingDate", placeholder: "дд.мм.гггг", type: 'date' },
      ...
      { label: "Источник рекламы", name: "adSource", placeholder: "", type: 'select',
        options: [
          { value: "none", label: "Органический трафик" },
          { value: "yandexDirect", label: "Яндексд директ" },
  ...
  },
  {
    ...
    fields: [
      ...
      { label: "Стоимость доставки для клиента", name: "deliveryIncome", type: "number", placeholder: "например: 500 ₽" },
      { label: "Себестоимость букета", name: "bouquetCost", type: "number", placeholder: "себестоимость ₽" },
      { label: "Стоимость доставки курьером", name: "deliveryExpense", type: "number", placeholder: "например: 200 ₽" },
    ...
    fields: [
      {
        ...
        type: "select",
        options: [
          // { value: "Новая заявка", label: "Новая заявка)" },
